...
def create_client_view(request):
    if request.method == 'POST':
        ...
        form = ClientForm()
    return render(request, 'shopapp/create_client.html', {'form': form})


# Представление для отображения всех клиентов
def all_clients_view(request):
    clients = Client.objects.all()
    return render(request, 'shopapp/all_clients.html', {'clients': clients})
...
def update_client_view(request, client_id):
    ...
    return render(request, 'shopapp/update_client.html', {'form': form, 'client': client})
...
def delete_client_view(request, client_id):
    ...
    if request.method == 'POST':
        client.delete()
        return redirect('all_clients')
    return render(request, 'shopapp/delete_client.html', {'client': client})
...
def client_ordered_products(request, client_id, days):
    ...
    return render(request, 'shopapp/client_ordered_products.html', context)
...
def update_product_view(request, product_id):
    ...
    return render(request, 'shopapp/update_product.html', {'form': form, 'product': product})
...
def delete_product_view(request, product_id):
    ...
    if request.method == 'POST':
        product.delete()
        return redirect('product_list')
    return render(request, 'shopapp/confirm_delete_product.html', {'product': product})
